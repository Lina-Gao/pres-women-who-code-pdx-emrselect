...
<img src="emr_bmj.jpg" style="width: 80%;"/>
...
<img src="nlp_murphy.png" style="width: 80%;"/>
...
```{r, echo=FALSE}
tmpdat <- readr::read_csv("emrselect_data_subsetRA.csv")
...
<img src="sims_auc.png" style="height: 80%"; ALIGN="right"/>
...
<img src="RA_AUC.pdf" style="height: 55%"; ALIGN="right"/>

## Results

<img src="ra_auc_table.png" style="height: 65%"/> <p style="font-size:20px", align="right">
...
<img src="i2b2.png" style="height: 80%"/>
